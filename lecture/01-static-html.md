...
- `https://<サイト>.ddev.site/practice/step1-html/index.html`
- `https://<サイト>.ddev.site/practice/step1-html/` でも同じ結果になる
...
- `/practice/step1-html/` → Nginx が `/practice/step1-html/index.html` を探して返す
- `/practice/step1-html/index.html` → 直接そのファイルを返す
